...
export default function Navigation() {
  ...
  const handleCategoryClickMobil = (category, section, item) => {
    navigate(`/${category.id}/${section.id}/${item.id}`);
    setOpen(false);
  };
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <img
                  ...
                  alt="Shopwithzosh"
                  className="cursor-pointer h-20 w-full mr-2"
                  onClick={() => navigate("/")}
                />
              </div>
              ...
              <PopoverGroup className="hidden lg:ml-8 lg:block lg:self-stretch z-10">
                <div className="flex h-full space-x-8">
                  ...
                  <a href="" onClick={handleCompany} className="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">
                    Contacto
                  </a>
                </div>
              </PopoverGroup>
